    ...
    return (
      <section id="about">
        ...
        <p className="about-desc">
          ...
          items and reconnect with cherished possessions. At <span >Retrievia</span>, we
        ...
        <footer>
            <p>For more details visit: <a href="https://github.com/PrathamTripathi29">PrathamTripathi-Github</a></p>
        </footer>
      </section>
